...
def main():
    ...
    G = open_file(sys.argv[1])# args: 'python', 'general.py', 's1.dat', 'Cb'
    ...
    open_list = [state_node([["EXIT","",0], [], [], 0, 0, 0, [], init_stack_occupied])]    # the CTS starts at the EXIT node, with no casks
    closed_list = []
    ...
    while 1:
        ...
        #current = choose_next_node(open_list, closed_list)
